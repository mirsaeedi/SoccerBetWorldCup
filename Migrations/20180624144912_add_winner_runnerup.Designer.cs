...
namespace SoccerBet.Migrations
{
    ...
    [Migration("20180624144912_add_winner_runnerup")]
    partial class add_winner_runnerup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoccerBet.Data.Models.WorldCupGroup", b =>
                {
                    b.HasOne("SoccerBet.Data.Models.Team", "Runnerup")
                        .WithMany()
                        .HasForeignKey("RunnerupId");

                    b.HasOne("SoccerBet.Data.Models.Team", "Winner")
                        .WithMany()
