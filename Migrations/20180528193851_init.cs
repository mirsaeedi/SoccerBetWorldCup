        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    FirstTeamScore_TeamId = table.Column<long>(nullable: false),
                    FirstTeamScore_Score = table.Column<short>(nullable: true),
                    SecondTeamScore_TeamId = table.Column<long>(nullable: false),
                    SecondTeamScore_Score = table.Column<short>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.FirstTeamScore_TeamId,
                        principalTable: "Team",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Game_Team_SecondTeamScore_TeamId",
                        column: x => x.SecondTeamScore_TeamId,
                        principalTable: "Team",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
